# Assignment Determination & Monitoring
...
- **EC §44001** — defines a "position requiring certification qualifications" as every type of service for which certification qualifications are established.
- **EC §44830** — a governing board shall employ, for positions requiring certification qualifications, only persons who possess the qualifications prescribed by law.
- **EC §35035(g)** — it is the duty of each district superintendent to ensure certificated staff hold valid documents authorizing them to serve in their assigned positions.
- **EC §44258.9** — all California K-12 schools are monitored on an annual basis.

**Employers have a legal obligation to appropriately assign educators.** Violations result in **misassignments**, which should be corrected within **30 calendar days** of identification.
...
1. **Credential** (fully prepared educator)
2. **University or District Intern** credential
3. **Local Assignment Options** (LAOs)
4. **Emergency and Teaching Permits**
5. **Waivers** (last resort)

**Note:** County offices and school districts are prohibited from paying the salary of any person employed in a position requiring certification qualifications while not holding a "proper" certification document (EC §45034).
...
2. **What is the primary course content?** (the subject matter)
...
1. **What is the primary focus of the curriculum?** If one subject prevails, that is likely the primary content.
2. **Is graduation credit assigned?** If the course fulfills a graduation requirement in a subject, that subject is likely the primary content.
3. **Is A-G credit assigned?** If the course satisfies UC A-G credit in a subject, that subject is likely the content.
4. **Is no credit assigned?** If the course fits no subject area, it may be an **elective**.

If still uncertain, consult the site's curriculum/instruction coordinator, who can evaluate the course against California's Curriculum Frameworks and contact the CDE if necessary.
...
|---------|-------------|------------------------|
| **Self-Contained** | Same group of students taught multiple subjects by one educator all day (usually elementary) | **Multiple Subject** (TC2) |
| **Departmentalized** | Instructor teaches a specific subject to several groups of students (usually middle/high school) | **Single Subject** (TC1) |
| **Special Education** | One or more subjects taught to students identified as needing special ed services | **Education Specialist Instruction** (TC3S) |
| **Career Technical Education (CTE)** | Curriculum designated as technical, trade, or vocational; 50%+ based on CTE Model Curriculum Standards | **Designated Subjects CTE** (CTE) or related **Single Subject** |
| **Adult Education** | Program for adults 18+ (HS diploma, GED, jobs, ESL, citizenship) | **Designated Subjects Adult Education** (AETC), or TC2/TC1/CTE |
| **English Learners** | EL students must be taught by educators with an appropriate EL authorization | EL authorizations (see below) |
| **Child Development** | Child care and development programs, children ages 5 and below | **Child Development Permits** |
...
### Single Subject (TC1) — Departmentalized
- Authorizes teaching the subject area(s) listed in departmentalized settings in grades 12 and below, including preschool, and in classes organized for adults.
- **Also allows:** subsumed subjects, some CTE courses, electives, and substitute for an unlimited amount of time in the subject area of authorization.

### Education Specialist (TC3S) — Special Education
- Authorizes providing special education services and related services within the disability authorized by the credential.
...
**Important:** A Single Subject credential in English does **not** authorize English Learner Services.

### Types of EL Services

| Service | Description | Authorizing Documents (codes) |
|---------|-------------|-------------------------------|
| **Bilingual Instruction** | Primary language development and content instruction delivered in the primary language (e.g., math taught in Spanish). Issued in a specific language — the classroom language must match the authorization. | Bilingual Authorization (BA**), Emergency Bilingual Authorization Permit |
| **Departmentalized ELD** | Standalone ELD class (no other content instruction). Reported in CALPADS with course code **9104**. | Full ELA (ELA1), CLAD Certificate (SA12), Bilingual Auth (BA**), Single Subject World Language: ELD (WLEL/WLEX), Supplemental Auth ESL (R1B) |
| **Designated ELD** | Protected time during the day for focused ELD standards instruction based on proficiency level. | ELAM/ELAS/ELAE, ELA1, SA12, BA**, WLEL/WLEX, R1B |
...
4. Designated and Integrated ELD (not primary language)
...
|-----|----------|-----------|---------|---------|-------|---------|-------|--------------------|
| **Electives** | T5 §80005(b) | BA + student teaching | Departmentalized | Electives | K-12 | Yes | No | Yes |
| **Alternative settings** | EC §44865 | BA + student teaching | Alternative (home, hospital, continuation, etc.) | Any | K-12 | Yes | No | No |
| **Departmentalized (MS)** | EC §44256(b) | Multiple Subject/Elementary | Departmentalized | Any | 8 and below | Yes | Yes | Yes (12 lower/6 upper units) |
| **Committee on Assignments** | EC §44258.7(c)(d) | Any teaching credential | Departmentalized | Electives | K-12 | Yes | Yes | Yes |
| **Departmentalized (any)** | EC §44258.3 | Non-emergency credential | Departmentalized | Any | K-12 | Yes | Yes | Yes |
| **Any content** | EC §44263 | Any teaching credential | Departmentalized/Self-Contained | Any | K-12 | Not specified | Yes | Yes (18 lower/9 upper units dept; 60 semester hrs self-contained) |
| **Middle school** | EC §44258.2 | Single Subject/Secondary | Departmentalized | Any | 5-8 | Yes | Yes | Yes (12 lower/6 upper units) |
...
- **Teaching Permit for Statutory Leave** — for teaching during a statutory leave.
- **Emergency Specialist Teaching Permit in Early Childhood Education (ETK)** — authorizes teaching in a self-contained general education TK classroom; issued with an EL authorization; employing agency must request.
...
1. Does the educator have the appropriate authorization for their assignment?
   ...
   - If services and authorization are appropriate but an exception was generated → **CALPADS Error**.
...
3. If either is true, does a **credential exist** that covers the assignment's subject or setting?
...
| Setting/Scenario | Traditional | Charter (pre-2020) | Charter (post-2020) |
|------------------|-------------|--------------------|----------------------|
| CTC Professional Fitness evaluation | Yes | No | **Yes** |
| Included in Regular Assignment Monitoring | Yes | No | **Yes** |
| General Ed: Core/College Prep | Yes | Yes | Yes |
| General Ed: Non-core/Non-College Prep | Yes | No | **Yes** |
| Special Education | Yes | Yes | Yes |
| English Learner Services | Yes | Yes | Yes |
| Career Technical Education | Yes | No | **Yes** |
| Non-Classroom based Support/Service | Yes | No | No |

**Assignment Flexibility (EC §44258.10):** Charter schools are not required to correct the misassignment of unqualified educators previously employed in non-core/non-college prep positions until **July 1, 2025** (subject to eligibility criteria).
...
- These sections are **specific to local community colleges** and do **not** apply to four-year institutions.
- **EC §76004** requires the school district and community college district partners to comply with state and federal reporting requirements regarding teacher/faculty qualifications for the course offered for high school credit.
- The partnership agreement must specify which district is the **employer of record** for assignment monitoring and reporting.
- An appropriately credentialed **Single Subject** teacher may also serve students in these programs.
...
- **Software-based, self-paced, no grades/records:** may be proctored by a **supervised classified employee**. Report in CALPADS with Online Course Instruction Type Code **3 (Learner Led)**.
- **Software-based with grades:** **T5 §80005(b)** may be utilized.
- **Teacher as facilitator (support/re-teaching):** any fully credentialed teacher can be the teacher of record under **T5 §80005(b)**. Report with Online Course Instruction Type Code **2 (Teacher Led)**.
...
- **UC A-G Course List** — UC approves courses for specific content-area credit (A-G). These designations help determine course content.
- **ESSA Compliance** — Under ESSA (replacing NCLB), teachers are no longer required to be "highly qualified." Federal law now requires teachers be assigned **solely based on state licensing requirements**.
...
| Module | Handout |
|--------|---------|
| Assignment Orientation | `handout-assignment-orientation.pdf` |
| Introductory Module | `handout-introductory-module.pdf` |
| Self-Contained Settings | `handout-self-contained-settings.pdf` |
| Transitional Kindergarten | `handout-transitional-kindergarten.pdf` |
| English Learner Services | `handout-english-learner.pdf` |
| Local Assignment Options | `handout-local-assignment-options.pdf` |
| Determining Course Content | `handout-determining-course-content.pdf` |

**Key source pages** (all downloaded to `raw/assignment-resources/`):
- Assignment School: https://www.ctc.ca.gov/employers/assignment-resources/resources/assignment-school/
- Assignment Monitoring: https://www.ctc.ca.gov/employers/assignment-resources/assignment-monitoring/
- Assignment Options: https://www.ctc.ca.gov/employers/assignment-resources/assignment-options/
- Common Local Assignment Options: https://www.ctc.ca.gov/employers/assignment-resources/local-assignment/
- CalSAAS: https://www.ctc.ca.gov/employers/calsaas/
- Authorization Sort Table: https://www.ctc.ca.gov/employers/assignment-resources/resources/authorization-sort-table/
...
3. **Hiring hierarchy** (EC §44225.7): Credential → Intern → LAO → Emergency Permit → Waiver.
4. **Course content determines the credential** — identify the setting, primary content, grade level, and standards.
5. **LAOs** let LEAs assign out-of-field with teacher consent + board action, but **cannot** be used for Special Ed, CTE, or EL assignments.
6. **EL services** require specific EL authorizations; a Single Subject in English does not authorize EL services.
7. **Monitoring** is done annually via **CalSAAS** by County Offices, the Commission, and district chartering authorities.
